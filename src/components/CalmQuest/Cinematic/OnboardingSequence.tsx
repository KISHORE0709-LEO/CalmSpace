...
import { Sparkles, Gamepad2, Zap, Shield, Heart, Brain, Trophy, Star, Target, Users, Flame, MessageCircle, Award, ArrowRight, CheckCircle2 } from "lucide-react";
...
export const OnboardingSequence = ({ onComplete }: Props) => {
  ...
  return (
    <>
      ...
      {mounted && createPortal(<FloatingElements />, document.body)}

      <div className="w-full min-h-[calc(100vh-8rem)] flex items-center justify-center animate-fade-up py-16">
        <div className="flex flex-col items-center text-center px-6 max-w-5xl w-full gap-7">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground font-medium leading-relaxed w-full">
            Master real-world social situations in a safe, interactive world built just for you.
          </p>
