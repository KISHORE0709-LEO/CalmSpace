      ...
      <div className="w-full px-6 md:px-12 flex items-center justify-between">
        ...
        <div className="flex-1 flex justify-start">
          <Link to="/" className="flex items-center gap-3 px-2 py-2 transition-transform hover:-translate-y-[2px] shrink-0">
            ...
            <span className="hidden xl:inline text-2xl tracking-tight text-foreground font-black">CalmSpace</span>
          </Link>
        </div>
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `pill-nav-item flex items-center gap-2 px-3 lg:px-4 py-2 text-xs lg:text-sm font-bold whitespace-nowrap transition-all duration-200 ${
                    isActive ? "bg-primary text-primary-foreground border-2 border-foreground shadow-pop-sm" : "border-2 border-transparent hover:bg-accent"
                  }`
                }
              >
