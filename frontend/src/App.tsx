...
import { EmotionProvider } from "./context/EmotionContext.tsx";
// Parent Pages
...
import CaregiverTherapySummary from "./pages/caregiver/TherapySummary.tsx";
        ...
        <EmotionProvider>
          <BrowserRouter>
            <Routes>
              ...
              <Route path="/caregiver/therapy/summary" element={<CaregiverTherapySummary />} />
