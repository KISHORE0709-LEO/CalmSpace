...
const LiveEmotion = () => {
  ...
  return (
    <CaregiverShell title="Live Session View" subtitle="Real-time monitoring and immediate guidance" fullWidth>
      <div className="grid lg:grid-cols-12 gap-6 pb-12 animate-fade-up items-start">
        ...
        <div className="lg:col-span-3 flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <h4 className="font-black text-lg text-red-900">Log Moment</h4>
                </div>
              </div>
            ...
            <button 
              onClick={() => navigate("/caregiver/chat")}
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div className="text-left">
                  <h4 className="font-black text-lg text-purple-900">Notify Parent</h4>
                </div>
              </div>
            </button>
