        ...
        <div className="flex flex-col gap-8">
              ...
              <div className="w-full md:w-[60%] flex flex-col justify-center relative z-10">
                ...
                <div className="space-y-2 mb-4 bg-muted/30 p-3 rounded-2xl border-2 border-foreground/10">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs font-bold text-muted-foreground">Parent: <span className="text-foreground font-black">You (Leo's Father)</span></span>
                  </div>
                </div>

                <button 
                  onClick={() => navigate("/parent/therapy/room")}
              ...
              <div className="calm-card bg-card border-4 border-primary shadow-pop-lg rounded-[2rem] p-6 sm:p-8 flex flex-col relative overflow-hidden group">
                ...
                <div className="flex items-start gap-4 mb-6 relative z-10">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-bold text-muted-foreground mb-3">Requested by Dr. Emily Watson</p>
          ...
          <div className="mt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              {/* Summary 1 */}
              <div className="calm-card bg-background border-4 border-foreground shadow-pop-sm rounded-[1.5rem] p-6 hover:-translate-y-2 transition-transform cursor-pointer group flex flex-col h-full">
