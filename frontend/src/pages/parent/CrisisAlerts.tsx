  ...
  return (
    <ParentShell title="" subtitle="" fullWidth>
      ...
      <div className="w-full max-w-[96%] mx-auto pt-4 h-full flex flex-col">
        ...
        {/* HEADER SECTION */}
        <div className="flex flex-col md:flex-row md:items-end justify-end mb-8 gap-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
                ...
                <div className="w-full md:w-[45%] flex flex-col justify-center">
                  <div className="bg-accent/30 rounded-[1.5rem] p-6 h-full flex flex-col justify-center border-4 border-foreground shadow-pop-sm relative">
                    ...
                    <button className="w-full bg-secondary hover:bg-secondary/90 text-secondary-foreground transition-all rounded-xl py-3 border-4 border-foreground shadow-pop flex flex-col items-center justify-center gap-0.5 mt-auto hover:-translate-y-1">
                      ...
                      <span className="text-[10px] font-bold opacity-80">Notify Care Team</span>
                    </button>
            ...
            {/* Why Now Card */}
            <div className="calm-card flex flex-col sm:flex-row items-start gap-6 bg-card border-4 border-foreground shadow-pop-sm">
          ...
          <div className="lg:col-span-4 h-full">
            <div className="calm-card h-full flex flex-col bg-card border-4 border-foreground shadow-pop-sm">
