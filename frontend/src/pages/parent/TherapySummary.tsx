...
export default function TherapySummary() {
  return (
    <ParentShell title="Session Summary" subtitle="Review Dr. Mehta's notes and recommendations">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-8">
            ...
            <div className="calm-card space-y-4">
              ...
              <div className="space-y-4 text-base font-medium leading-relaxed">
                ...
                <div className="bg-muted p-4 rounded-xl border-2 border-foreground/10 text-sm font-bold text-muted-foreground">
                  "Rahul's eye contact improved significantly when discussing his favorite cartoon characters. We will use this interest to build more social reciprocity next week."
                </div>
              </div>
            </div>
            ...
            <div className="calm-card space-y-4 bg-accent/20 border-accent-foreground/20">
              <h3 className="text-xl font-black flex items-center gap-2 border-b-2 border-foreground/10 pb-3">
                <Activity className="w-6 h-6 text-accent-foreground" /> Doctor's Recommendations
              </h3>
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-accent-foreground shrink-0 mt-0.5" />
                  <span className="font-medium">Maintain a strict visual schedule for morning transitions to reduce anxiety.</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-accent-foreground shrink-0 mt-0.5" />
                  <span className="font-medium">Praise specific social behaviors (e.g., "I like how you looked at me when asking for juice").</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-accent-foreground shrink-0 mt-0.5" />
                  <span className="font-medium">Limit screen time 1 hour before bed to improve sleep quality.</span>
                </li>
              </ul>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="calm-card space-y-4">
              <h3 className="text-xl font-black flex items-center gap-2 border-b-2 border-foreground/10 pb-3">
                <Heart className="w-6 h-6 text-secondary-foreground" /> Assigned Home Activities
              </h3>
              <p className="text-sm font-medium text-muted-foreground mb-4">Please practice these exercises with Rahul before the next session.</p>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-background border-2 border-foreground shadow-pop-sm p-4 rounded-xl flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-medium text-muted-foreground mb-2">Do this when Rahul seems agitated.</p>
            ...
            <div className="calm-card space-y-4 bg-muted border-foreground/20">
              ...
              <Button className="w-full h-12 font-black border-2 border-foreground shadow-pop-sm bg-white text-foreground hover:bg-background">
                Reschedule
              </Button>
            </div>
